...
impl Window {
    ...
    pub fn id(&self) -> WindowId {
        let _span = tracing::debug_span!("better_window::Window::id",).entered();
    ...
    pub fn scale_factor(&self) -> f64 {
        let _span = tracing::debug_span!("better_window::Window::scale_factor",).entered();
    ...
    pub fn request_redraw(&self) {
        let _span = tracing::debug_span!("better_window::Window::request_redraw",).entered();
    ...
    ///
    /// ```no_run
    /// # use better_window::window::Window;
    /// # fn swap_buffers() {}
    ...
    pub fn pre_present_notify(&self) {
        let _span =
            tracing::debug_span!("better_window::Window::pre_present_notify",).entered();
    ...
    pub fn reset_dead_keys(&self) {
        let _span =
            tracing::debug_span!("better_window::Window::reset_dead_keys",).entered();
...
impl Window {
    ...
    pub fn inner_position(&self) -> Result<PhysicalPosition<i32>, NotSupportedError> {
        let _span = tracing::debug_span!("better_window::Window::inner_position",).entered();
    ...
    pub fn outer_position(&self) -> Result<PhysicalPosition<i32>, NotSupportedError> {
        let _span = tracing::debug_span!("better_window::Window::outer_position",).entered();
    ...
    ///
    /// ```no_run
    /// # use better_window::dpi::{LogicalPosition, PhysicalPosition};
    /// # use better_window::window::Window;
    /// # fn scope(window: &Window) {
    ...
    pub fn set_outer_position<P: Into<Position>>(&self, position: P) {
        ...
        let _span = tracing::debug_span!(
            "better_window::Window::set_outer_position",
            position = ?position
        )
        .entered();
    ...
    pub fn inner_size(&self) -> PhysicalSize<u32> {
        let _span = tracing::debug_span!("better_window::Window::inner_size",).entered();
    ...
    ///
    /// ```no_run
    /// # use better_window::dpi::{LogicalSize, PhysicalSize};
    /// # use better_window::window::Window;
    /// # fn scope(window: &Window) {
    ...
    pub fn request_inner_size<S: Into<Size>>(
        ...
        let size = size.into();
        let _span = tracing::debug_span!(
            "better_window::Window::request_inner_size",
            size = ?size
        )
        .entered();
        self.window
    ...
    pub fn outer_size(&self) -> PhysicalSize<u32> {
        let _span = tracing::debug_span!("better_window::Window::outer_size",).entered();
    ...
    pub fn set_min_inner_size<S: Into<Size>>(&self, min_size: Option<S>) {
        ...
        let _span = tracing::debug_span!(
            "better_window::Window::set_min_inner_size",
            min_size = ?min_size
        )
        .entered();
        self.window
    ...
    pub fn resize_increments(&self) -> Option<PhysicalSize<u32>> {
        let _span =
            tracing::debug_span!("better_window::Window::resize_increments",).entered();
    ...
    pub fn set_resize_increments<S: Into<Size>>(&self, increments: Option<S>) {
        ...
        let _span = tracing::debug_span!(
            "better_window::Window::set_resize_increments",
...
impl Window {
    ...
    pub fn set_title(&self, title: &str) {
        let _span =
            tracing::debug_span!("better_window::Window::set_title", title).entered();
    ...
    pub fn set_transparent(&self, transparent: bool) {
        let _span =
            tracing::debug_span!("better_window::Window::set_transparent", transparent)
                .entered();
        self.window
    ...
    pub fn set_blur(&self, blur: bool) {
        let _span = tracing::debug_span!("better_window::Window::set_blur", blur).entered();
    ...
    pub fn set_visible(&self, visible: bool) {
        let _span =
            tracing::debug_span!("better_window::Window::set_visible", visible).entered();
        self.window
    ...
    pub fn is_visible(&self) -> Option<bool> {
        let _span = tracing::debug_span!("better_window::Window::is_visible",).entered();
    ...
    pub fn set_resizable(&self, resizable: bool) {
        let _span = tracing::debug_span!("better_window::Window::set_resizable", resizable)
            .entered();
        self.window
    ...
    pub fn is_resizable(&self) -> bool {
        let _span = tracing::debug_span!("better_window::Window::is_resizable",).entered();
    ...
    pub fn set_enabled_buttons(&self, buttons: WindowButtons) {
        let _span = tracing::debug_span!(
            "better_window::Window::set_enabled_buttons",
            buttons = ?buttons
        )
        .entered();
        self.window
    ...
    pub fn enabled_buttons(&self) -> WindowButtons {
        let _span =
            tracing::debug_span!("better_window::Window::enabled_buttons",).entered();
    ...
    pub fn set_minimized(&self, minimized: bool) {
        let _span = tracing::debug_span!("better_window::Window::set_minimized", minimized)
            .entered();
        self.window
    ...
    pub fn is_minimized(&self) -> Option<bool> {
        let _span = tracing::debug_span!("better_window::Window::is_minimized",).entered();
    ...
    pub fn set_maximized(&self, maximized: bool) {
        let _span = tracing::debug_span!("better_window::Window::set_maximized", maximized)
            .entered();
        self.window
    ...
    pub fn is_maximized(&self) -> bool {
        let _span = tracing::debug_span!("better_window::Window::is_maximized",).entered();
    ...
    pub fn set_fullscreen(&self, fullscreen: Option<Fullscreen>) {
        let _span = tracing::debug_span!(
            "better_window::Window::set_fullscreen",
    ...
    pub fn fullscreen(&self) -> Option<Fullscreen> {
        let _span = tracing::debug_span!("better_window::Window::fullscreen",).entered();
        self.window
    ...
    pub fn set_decorations(&self, decorations: bool) {
        let _span =
            tracing::debug_span!("better_window::Window::set_decorations", decorations)
                .entered();
        self.window
    ...
    pub fn is_decorated(&self) -> bool {
        let _span = tracing::debug_span!("better_window::Window::is_decorated",).entered();
    ...
    pub fn set_window_level(&self, level: WindowLevel) {
        let _span = tracing::debug_span!(
            "better_window::Window::set_window_level",
            level = ?level
        )
        .entered();
        self.window
    ...
    pub fn set_window_icon(&self, window_icon: Option<Icon>) {
        let _span =
            tracing::debug_span!("better_window::Window::set_window_icon",).entered();
        self.window
    ...
    ///
    /// ```no_run
    /// # use better_window::dpi::{LogicalPosition, PhysicalPosition, LogicalSize, PhysicalSize};
    /// # use better_window::window::Window;
    /// # fn scope(window: &Window) {
    /// // Specify the position in logical dimensions like this:
    ...
    pub fn set_ime_cursor_area<P: Into<Position>, S: Into<Size>>(
        ...
        let size = size.into();
        let _span = tracing::debug_span!(
            "better_window::Window::set_ime_cursor_area",
            position = ?position,
            size = ?size,
        )
        .entered();
    ...
    pub fn set_ime_allowed(&self, allowed: bool) {
        let _span = tracing::debug_span!("better_window::Window::set_ime_allowed", allowed)
            .entered();
        self.window
    ...
    pub fn set_ime_purpose(&self, purpose: ImePurpose) {
        let _span = tracing::debug_span!(
            "better_window::Window::set_ime_purpose",
            purpose = ?purpose
        )
        .entered();
        self.window
    ...
    pub fn focus_window(&self) {
        let _span = tracing::debug_span!("better_window::Window::focus_window",).entered();
    ...
    pub fn has_focus(&self) -> bool {
        let _span = tracing::debug_span!("better_window::Window::has_focus",).entered();
    ...
    pub fn request_user_attention(&self, request_type: Option<UserAttentionType>) {
        let _span = tracing::debug_span!(
            "better_window::Window::request_user_attention",
    ...
    pub fn set_theme(&self, theme: Option<Theme>) {
        let _span = tracing::debug_span!(
            "better_window::Window::set_theme",
            theme = ?theme
        )
        .entered();
    ...
    pub fn theme(&self) -> Option<Theme> {
        let _span = tracing::debug_span!("better_window::Window::theme",).entered();
    ...
    pub fn set_content_protected(&self, protected: bool) {
        let _span =
            tracing::debug_span!("better_window::Window::set_content_protected", protected)
                .entered();
        self.window
    ...
    pub fn title(&self) -> String {
        let _span = tracing::debug_span!("better_window::Window::title",).entered();
...
impl Window {
    ...
    pub fn set_cursor(&self, cursor: impl Into<Cursor>) {
        ...
        let _span = tracing::debug_span!("better_window::Window::set_cursor",).entered();
        self.window
    ...
    pub fn set_cursor_position<P: Into<Position>>(
        ...
        let position = position.into();
        let _span = tracing::debug_span!(
            "better_window::Window::set_cursor_position",
            position = ?position
        )
        .entered();
        self.window
    ...
    ///
    /// ```no_run
    /// # use better_window::window::{CursorGrabMode, Window};
    /// # fn scope(window: &Window) {
    /// window
    ...
    pub fn set_cursor_grab(&self, mode: CursorGrabMode) -> Result<(), ExternalError> {
        let _span = tracing::debug_span!(
            "better_window::Window::set_cursor_grab",
            mode = ?mode
        )
        .entered();
    ...
    pub fn set_cursor_visible(&self, visible: bool) {
        let _span =
            tracing::debug_span!("better_window::Window::set_cursor_visible", visible)
                .entered();
        self.window
    ...
    pub fn drag_window(&self) -> Result<(), ExternalError> {
        let _span = tracing::debug_span!("better_window::Window::drag_window",).entered();
    ...
    pub fn drag_resize_window(
        ...
        let _span = tracing::debug_span!(
            "better_window::Window::drag_resize_window",
            direction = ?direction
        )
        .entered();
        self.window
    ...
    pub fn show_window_menu(&self, position: impl Into<Position>) {
        let position = position.into();
        let _span = tracing::debug_span!(
            "better_window::Window::show_window_menu",
            position = ?position
        )
        .entered();
        self.window
    ...
    pub fn set_cursor_hittest(&self, hittest: bool) -> Result<(), ExternalError> {
        let _span =
            tracing::debug_span!("better_window::Window::set_cursor_hittest", hittest)
                .entered();
        self.window
...
impl Window {
    ...
    pub fn current_monitor(&self) -> Option<MonitorHandle> {
        let _span =
            tracing::debug_span!("better_window::Window::current_monitor",).entered();
        self.window.maybe_wait_on_main(|w| {
    ...
    pub fn available_monitors(&self) -> impl Iterator<Item = MonitorHandle> {
        let _span =
            tracing::debug_span!("better_window::Window::available_monitors",).entered();
        self.window.maybe_wait_on_main(|w| {
    ...
    pub fn primary_monitor(&self) -> Option<MonitorHandle> {
        let _span =
            tracing::debug_span!("better_window::Window::primary_monitor",).entered();
        self.window.maybe_wait_on_main(|w| {
