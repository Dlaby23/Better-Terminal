...
pub trait EventLoopBuilderExtWindows {
    ...
    ///
    /// ```
    /// use better_window::event_loop::EventLoopBuilder;
    /// #[cfg(target_os = "windows")]
    /// use better_window::platform::windows::EventLoopBuilderExtWindows;
    ///
...
pub trait WindowExtWindows {
    ...
    /// use better_window::raw_window_handle::HasWindowHandle;
    ///
