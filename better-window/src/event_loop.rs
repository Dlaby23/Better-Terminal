...
impl<T> EventLoopBuilder<T> {
    ...
    pub fn build(&mut self) -> Result<EventLoop<T>, EventLoopError> {
        let _span = tracing::debug_span!("better_window::EventLoopBuilder::build").entered();
...
impl<T> EventLoop<T> {
    ...
    {
        let _span = tracing::debug_span!("better_window::EventLoop::run").entered();
    ...
    pub fn listen_device_events(&self, allowed: DeviceEvents) {
        let _span = tracing::debug_span!(
            "better_window::EventLoop::listen_device_events",
            allowed = ?allowed
        )
        .entered();
    ...
    pub fn set_confirm_before_quit(&self, confirmation: bool) {
        let _span =
            tracing::debug_span!("better_window::EventLoop::set_confirm_before_quit")
                .entered();
    ...
    pub fn create_window(
        ...
        let _span = tracing::debug_span!(
            "better_window::EventLoop::create_window",
...
impl ActiveEventLoop {
    ...
    pub fn create_window(
        ...
        let _span = tracing::debug_span!(
            "better_window::ActiveEventLoop::create_window",
            window_attributes = ?window_attributes
        )
        .entered();
    ...
    pub fn create_custom_cursor(
        ...
        let _span =
            tracing::debug_span!("better_window::ActiveEventLoop::create_custom_cursor",)
                .entered();
    ...
    pub fn available_monitors(&self) -> impl Iterator<Item = MonitorHandle> {
        let _span =
            tracing::debug_span!("better_window::ActiveEventLoop::available_monitors",)
                .entered();
    ...
    pub fn primary_monitor(&self) -> Option<MonitorHandle> {
        let _span = tracing::debug_span!("better_window::ActiveEventLoop::primary_monitor",)
            .entered();
    ...
    pub fn listen_device_events(&self, allowed: DeviceEvents) {
        let _span = tracing::debug_span!(
            "better_window::ActiveEventLoop::listen_device_events",
            allowed = ?allowed
        )
        .entered();
    ...
    pub fn exit(&self) {
        let _span = tracing::debug_span!("better_window::ActiveEventLoop::exit",).entered();
...
impl<T: 'static> EventLoopProxy<T> {
    ...
    pub fn send_event(&self, event: T) -> Result<(), EventLoopClosed<T>> {
        let _span =
            tracing::debug_span!("better_window::EventLoopProxy::send_event",).entered();
