...
use better_terminal::config::CursorConfig;
use better_terminal::crosswords::grid::row::Row;
use better_terminal::crosswords::pos::CursorState;
use better_terminal::crosswords::square::Square;
...
pub struct HintLabel {
    pub position: better_terminal::crosswords::pos::Pos,
    pub label: Vec<char>,
    pub is_first: bool,
}
...
pub struct RenderableContent {
    ...
    pub hint_matches: Option<Vec<better_terminal::crosswords::search::Match>>,
