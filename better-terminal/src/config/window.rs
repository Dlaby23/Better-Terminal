...
use better_gpu::ImageProperties;
...
impl Colorspace {
    pub fn to_better_gpu_colorspace(&self) -> better_gpu::Colorspace {
        match self {
            Colorspace::Srgb => better_gpu::Colorspace::Srgb,
            Colorspace::DisplayP3 => better_gpu::Colorspace::DisplayP3,
            Colorspace::Rec2020 => better_gpu::Colorspace::Rec2020,
        }
    }

    #[cfg(target_os = "macos")]
    pub fn to_better_window_colorspace(&self) -> better_window::platform::macos::Colorspace {
        match self {
            Colorspace::Srgb => better_window::platform::macos::Colorspace::Srgb,
            Colorspace::DisplayP3 => better_window::platform::macos::Colorspace::DisplayP3,
            Colorspace::Rec2020 => better_window::platform::macos::Colorspace::Rec2020,
        }
    }

    #[cfg(not(target_os = "macos"))]
    pub fn to_better_window_colorspace(&self) {
