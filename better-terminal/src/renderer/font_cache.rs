use lru::LruCache;
use better_terminal::better_gpu::font_introspector::Attributes;
...
impl FontCache {
    ...
    pub fn pre_populate(
        ...
        let common_attrs = [
            Attributes::new(
                better_terminal::better_gpu::font_introspector::Stretch::NORMAL,
                better_terminal::better_gpu::font_introspector::Weight::NORMAL,
                better_terminal::better_gpu::font_introspector::Style::Normal,
            ),
            Attributes::new(
                better_terminal::better_gpu::font_introspector::Stretch::NORMAL,
                better_terminal::better_gpu::font_introspector::Weight::BOLD,
                better_terminal::better_gpu::font_introspector::Style::Normal,
            ),
            Attributes::new(
                better_terminal::better_gpu::font_introspector::Stretch::NORMAL,
                better_terminal::better_gpu::font_introspector::Weight::NORMAL,
                better_terminal::better_gpu::font_introspector::Style::Italic,
            ),
        ];
            ...
            for &ch in &common_chars {
                for &attrs in &common_attrs {
                    ...
                    if self.get(&key).is_none() {
                        let style = better_terminal::better_gpu::FragmentStyle {
                            font_attrs: attrs,
                            ..Default::default()
                        };
...
mod tests {
    use super::*;
    use better_terminal::better_gpu::font_introspector::{Stretch, Style, Weight};
