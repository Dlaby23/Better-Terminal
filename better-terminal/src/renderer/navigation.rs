...
use better_terminal::config::colors::Colors;
use better_terminal::config::navigation::{Navigation, NavigationMode};
...
impl ScreenNavigation {
    ...
    pub fn build_objects(
        ...
        colors: &Colors,
        context_manager: &crate::context::ContextManager<better_terminal::event::EventProxy>,
    ...
    pub fn tab(
        ...
        for i in tabs {
            ...
            let tab = better_gpu.create_temp_rich_text();
            better_gpu.set_rich_text_font_size(&tab, 14.);
