use better_terminal::crosswords::pos::{Column, Direction, Line, Pos};
use better_terminal::crosswords::search::Match;
use better_terminal::crosswords::search::{RegexIter, RegexSearch};
use better_terminal::crosswords::Crosswords;
use std::borrow::Cow;
use std::ops::Deref;
...
pub fn visible_regex_match_iter<'a, T: better_terminal::event::EventListener>(
    term: &'a Crosswords<T>,
...
impl<'a> HintMatches<'a> {
    ...
    #[inline]
    pub fn visible_regex_matches<T: better_terminal::event::EventListener>(
        term: &Crosswords<T>,
