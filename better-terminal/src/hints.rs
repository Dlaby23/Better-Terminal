use better_terminal::config::hints::Hint;
use better_terminal::crosswords::grid::Dimensions;
...
impl HintState {
    ...
    pub fn update_matches<T: EventListener>(
        &mut self,
        term: &better_terminal::crosswords::Crosswords<T>,
    ) {
        self.matches.clear();
...
mod tests {
    use super::*;
    use better_terminal::config::hints::{HintAction, HintInternalAction};
        ...
        state.matches = vec![
            HintMatch {
                ...
                start: better_terminal::crosswords::pos::Pos::new(
                    better_terminal::crosswords::pos::Line(0),
                    better_terminal::crosswords::pos::Column(0),
                ),
                end: better_terminal::crosswords::pos::Pos::new(
                    better_terminal::crosswords::pos::Line(0),
                    better_terminal::crosswords::pos::Column(5),
                ),
                hint: Rc::new(Hint {
                    regex: Some("test".to_string()),
                    hyperlinks: false,
            ...
            HintMatch {
                ...
                start: better_terminal::crosswords::pos::Pos::new(
                    better_terminal::crosswords::pos::Line(0),
                    better_terminal::crosswords::pos::Column(10),
                ),
                end: better_terminal::crosswords::pos::Pos::new(
                    better_terminal::crosswords::pos::Line(0),
                    better_terminal::crosswords::pos::Column(15),
                ),
                hint: Rc::new(Hint {
                    regex: Some("test".to_string()),
                    hyperlinks: false,
