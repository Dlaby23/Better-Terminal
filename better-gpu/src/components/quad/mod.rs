...
impl QuadBrush {
    pub fn new(context: &Context) -> QuadBrush {
        ...
        let instances = context.device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("better_gpu::quad Instances Buffer"),
        ...
        let constant_layout =
            context
                ...
                .create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                    label: Some("better_gpu::quad uniforms layout"),
        ...
        let transform = context.device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("better_gpu::quad uniforms buffer"),
        ...
        let constants = context
            ...
            .create_bind_group(&wgpu::BindGroupDescriptor {
                label: Some("better_gpu::quad uniforms bind group"),
        ...
        let layout =
            context
                ...
                .create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                    label: Some("better_gpu::quad pipeline"),
        ...
        let shader = context
            ...
            .create_shader_module(wgpu::ShaderModuleDescriptor {
                label: Some("better_gpu::quad shader"),
        ...
        let pipeline =
            context
                ...
                .create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                    cache: None,
                    label: Some("better_gpu::quad render pipeline"),
                    layout: Some(&layout),
    ...
    pub fn render<'a>(
        &'a mut self,
        context: &mut Context,
        state: &crate::better_gpu::state::SugarState,
        ...
        if total > self.supported_quantity {
            ...
            self.instances = context.device.create_buffer(&wgpu::BufferDescriptor {
                label: Some("better_gpu::quad instances"),
    ...
    pub fn render_single<'a>(
        ...
        if self.supported_quantity == 0 {
            ...
            self.instances = context.device.create_buffer(&wgpu::BufferDescriptor {
                label: Some("better_gpu::quad single instance"),
