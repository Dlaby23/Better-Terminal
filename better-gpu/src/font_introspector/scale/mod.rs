...
hinting enabled:
```ignore
# use better_gpu::font_introspector::{FontRef, CacheKey, scale::*};
...
```ignore
# use better_gpu::font_introspector::scale::*;
Render::new(&[
...
```ignore
# use better_gpu::font_introspector::{scale::{*, image::Image}, FontRef, GlyphId};
fn render_glyph(
